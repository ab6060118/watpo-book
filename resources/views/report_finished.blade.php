...
<head>
    ...
    <script>
        var darken = '<div class="darken" ></div>';
	        $('body').prepend(darken);
...
<div class="covering">
    <div class="progress">
        <div class="progress-bar" style="width: 100%;"> <span class="sr-only">100% Complete</span> </div>
    </div>
...
<div class="animated thanks fadeInDownBig">
  <h1 style="font-weight:100; font-size: 40px; width: 80%; margin: 0 auto; white-space:nowrap;">感謝您耐心填寫</h1>
  <form action="/">
