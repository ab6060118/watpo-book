...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::group(['prefix' => '/admin', 'middleware' => 'auth.login'], function () {
        ...
        Route::get('/activity', ['uses' => 'ActivityController@index', 'as' => 'activityIndex']);
        Route::post('/activity/add', ['uses' => 'ActivityController@add', 'as' => 'activityAdd']);
        Route::get('/activity/edit/{id}', ['uses' => 'ActivityController@edit', 'as' => 'activityEdit']);
        Route::post('/activity/update', ['uses' => 'ActivityController@update', 'as' => 'activityUpdate']);
        Route::post('/activity/delete', ['uses' => 'ActivityController@delete', 'as' => 'activityDelete']);

        Route::post('/prize/add', ['uses' => 'PrizeController@add', 'as' => 'prizeAdd']);
        Route::post('/prize/update', ['uses' => 'PrizeController@update', 'as' => 'prizeUpdate']);
        Route::post('/prize/delete', ['uses' => 'PrizeController@delete', 'as' => 'prizeDelete']);
    ...
    Route::group(['prefix' => '/api', 'middleware' => 'auth.login'], function () {
        ...
        Route::post('/account/reset_information', ['uses' => 'AccountController@api_reset_information', 'as' => 'apiAccountResetInformation']);
    ...
    //report form
    Route::get('/report', ['uses' => 'ReportController@getQuiz', 'as' => 'getQuiz']);
